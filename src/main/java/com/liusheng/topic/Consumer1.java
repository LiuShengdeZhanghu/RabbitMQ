...
public class Consumer1 {
    ...
    public void runConsumer() throws IOException, TimeoutException {
        ...
        // 声明当前消费者，一次消费多少个消息，可以根据消费者的处理能力进行设置，设置后就不用采用自动回调了
        channel.basicQos(1);
        ...
        DefaultConsumer consumer = new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                System.out.println("对红色动物感兴趣的消费者接收到消息："+new String(body, StandardCharsets.UTF_8));
                try {
                    Thread.sleep(100);
        ...
        System.out.println("对红色动物感兴趣的消费者开始监听队列！");
        // System.in.read()
        System.in.read();
        // 释放资源
        channel.close();
